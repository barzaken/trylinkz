  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div
        ref={ref}
        className={cn(
          "z-10 flex size-14 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_rgba(8,133,40,0.15)]",
          className
        )}
      >
        {children}
      ...
      {label && (
        <span className="text-xs dark:text-white/50 font-medium">{label}</span>
      )}
    </div>
  );
});
    ...
    <Container id="05"
      ...
      <>
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold textwhite mb-6">
            פיקסלים ו-UTM
            <span className="text-secondary"> בלי לאבד מידע</span>
          </h2>
...
function AnimatedBeamDia() {
  ...
  return (
    <div
      className="relative col-span-1 flex h-[320px] w-full items-center justify-center overflowhidden p10 py-10 "
      ref={containerRef}
    >
