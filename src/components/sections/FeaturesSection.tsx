  ...
  return (
    ...
    >
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div className="bg-sky-500 absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full md:bg-neutral-300 sm:dark:bg-neutral-700 group-hover/feature:bg-sky-500 dark:group-hover/feature:bg-sky-500 transition-all duration-200 origin-center" />
